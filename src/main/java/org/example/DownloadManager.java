...
public class DownloadManager {
    ...
    public void updateUI(FileInfo metaFile) {
        ...
        this.tableView.getItems().set(metaFile.getIndex() - 1, metaFile);
        this.tableView.refresh();
        System.out.println("---------------------");
    }
    @FXML
    public void initialize(){
        ...
        sn.setCellValueFactory(p->{
            int index = p.getValue().getIndex();
            SimpleStringProperty simpleStringProperty = new SimpleStringProperty(index+"");
